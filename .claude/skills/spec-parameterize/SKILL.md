...
1. **Nạp tri thức:** đọc `knowledge/glossary.md` (mục Naming), `knowledge/templates/parameter-table.md` và `knowledge/lessons.md`.
...
7. **Kết thúc:** `status: proposed`, chạy `sg validate`, rồi tóm tắt cho PR: danh sách parameter mới / tái sử dụng, và các điểm TBD.
