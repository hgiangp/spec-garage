...
| T5  | `sg export` + `--check` round-trip | ✅ | 💻 | `phase1/t5-export` | [export](guides/export.md) | Round-trip chính xác (trừ dòng trống) trên fixture ở 4 ngưỡng. **Chạy `sg export --check` trên 3 spec thật ở V1** |
| T4  | `sg validate` (V01–V10)                                                         | ⏳           | 🗄️      |                                           |                                                                                               | V04 kiểm qua`_anchors.yaml`                                                |
...
| -- | ------------------------------------------------------------------------------- | ------------ | ------------- | ------------------------------------------------------------------------------------- |
| V1 | `sg build-vault && sg export --check && sg validate` trên 3 spec                                  | ⏳           | 🗄️          | Sau T2, T4                                                                            |
